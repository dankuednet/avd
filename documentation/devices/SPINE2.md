...
| --------- | --------------- | ------------ | --------- |
| SPINES | Vlan4094 | 192.168.0.0 | Port-Channel31 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | FIREWALL_FIREWALL_Eth2 | *trunk | *20,30,40,50,60,80,110 | *- | *- | 5 |
| Ethernet23 | L2_LEAF5_Ethernet54 | *trunk | *10,20,30,50,60,100 | *- | *- | 23 |
| Ethernet25 | L2_LEAF4_Ethernet54 | *trunk | *10,20,30,50,60,100 | *- | *- | 25 |
| Ethernet27 | L2_LEAF3_Ethernet54 | *trunk | *10,20,30,50,60,100 | *- | *- | 27 |
| Ethernet29 | L2_LEAF2_Ethernet36 | *trunk | *10,20,30,50,60,100 | *- | *- | 29 |
| Ethernet31 | L2_LEAF1_Ethernet36 | *trunk | *10,20,30,50,60,100 | *- | *MLAG | 31 |
| Ethernet32 | MLAG_SPINE1_Ethernet32 | *trunk | *10,20,30,50,60,100 | *- | *MLAG | 31 |
...
interface Ethernet23
   description L2_LEAF5_Ethernet54
   no shutdown
   channel-group 23 mode active
!
interface Ethernet25
   description L2_LEAF4_Ethernet54
   no shutdown
   channel-group 25 mode active
!
interface Ethernet27
   description L2_LEAF3_Ethernet54
   no shutdown
   channel-group 27 mode active
!
interface Ethernet29
   description L2_LEAF2_Ethernet36
   no shutdown
   channel-group 29 mode active
!
interface Ethernet31
   description L2_LEAF1_Ethernet36
   no shutdown
   channel-group 31 mode active
!
interface Ethernet32
   description MLAG_SPINE1_Ethernet32
   no shutdown
   channel-group 31 mode active
```
